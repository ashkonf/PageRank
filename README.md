...
The pagerank module exports one public function:
     ...
     powerIteration(transition_weights, rsp=0.15, epsilon=0.00001, max_iterations=1000)
...
| `maxIterations`     | `int`                                         | The number of iterations after which power iteration will be terminated even if it has not yet converged.                                                                                                                                                                                                                                                                                                                                                                                                                                                     | True     | `1000`          |
